        ...
        <div className="bg-zinc-900 px-12 py-8 flex flex-col lg:flex-row gap-8 h-auto">
                  ...
                  {role !== "admin" && (
                    <>
                      ...
                      <button
                        ...
                        onClick={addToCart}
                      >
                        <PiShoppingCartFill className="me-4 md:me-0" />
                  ...
                  {role === "admin" && (
                    <>
                      ...
                      <button
                        ...
                        onClick={deleteBook}
                      >
                        <MdDeleteSweep className="me-4 md:me-0" />
          ...
          <div className="w-full lg:w-3/6 my-8">
            ...
            <p className="flex mt-4 items-center justify-start text-zinc-400">
              <TbWorld className="me-3" /> {Book.language}
            </p>
            <p className="mt-4 text-emerald-400 text-3xl font-semibold">
              Price : ₹ {Book.price}
            </p>
          </div>
        </div>
